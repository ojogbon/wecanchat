...
protected function insertToTables($table,$values) {
    ...
    protected function recentActivity ($type,$amonut,$user_id){
      
      return $this->insertToTables("`activity`(`id`, `user_id`, `type`, `amount`, `date`, `status`)",
      "VALUES (null,'$user_id','$type',$amonut,now(),'0')");
